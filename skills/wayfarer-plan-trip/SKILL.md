...
- Add a stay length after the link for stops that take real time: `[赤沼](geo:…) ~1h45`, `~45m`. The plugin never guesses a stay; without one it cannot place the following stops in time. A day needs only two or three real times plus stays on the long stops.
