...
const TABLE = {
  en: {
    ...
    day: "Day {n}", other: "Other", set_stay: "+ stay", stay_hint: "Click to set how long you stay", via_hint: "Click to change how you get there",
  ...
  "zh-TW": {
    ...
    day: "第 {n} 天", other: "其他", set_stay: "+ 停留", stay_hint: "點一下設定停留多久", via_hint: "點一下換交通方式",
